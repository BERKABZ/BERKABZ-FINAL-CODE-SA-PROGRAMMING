...
public class SignUp extends javax.swing.JFrame {
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        ...
        if (selectedHobbies.isEmpty()) {
            ...
            if (!errorOccurred) {
                try {
                    BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\Darel Briones\\OneDrive\\Documents\\Berkabz\\Berkabz\\STUDENTS ACCOUNT INFORMATION\\" + email_num + ".txt", true)); 
    ...
    File directory = new File("C:\\Users\\Darel Briones\\OneDrive\\Documents\\Berkabz\\Berkabz\\STUDENTS ACCOUNT INFORMATION\\");
