...
public class StudentInformation extends javax.swing.JFrame {
    ...
    private void displayStudent() {
        ...
        String filePathString = "C:\\Users\\Darel Briones\\OneDrive\\Documents\\Berkabz\\Berkabz\\STUDENT INFORMATION LIST\\StudentList.txt"; // Change the file path
...
private void updateReservationFile(DefaultTableModel model) {
    try {
        Path filePath = Paths.get("C:\\Users\\Darel Briones\\OneDrive\\Documents\\Berkabz\\Berkabz\\STUDENT INFORMATION LIST\\StudentList.txt");

        StringBuilder content = new StringBuilder();
        int rowCount = model.getRowCount();
        int columnCount = model.getColumnCount();

        content.append("STUDENTS LIST INFORMATION\n");
        content.append("--------------------------\n");
